...
export const metadata: Metadata = {
  title:
    "Aide à Domicile Rezé, Bouguenais, Bouaye | VES et Vous - Crédit Impôt 50%",
  description:
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Service de ménage régulier ou ponctuel pour domiciles et locaux professionnels",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Garde d'enfants occasionnelle ou régulière avec sorties d'école",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Service de repassage professionnel à domicile ou avec retrait/livraison",
          },
        },
      ],
    },
